...
namespace Microsoft.Diagnostics.Monitoring.Contracts
{
    ...
    public interface IPipeline
    {
        ...
        /// <summary>
        /// The pipeline will try to reach the Stopped state rapidly at the expense of discarding in-flight 
        /// data and ceasing communication with the source and sink. This will trigger StopAsync() and 
