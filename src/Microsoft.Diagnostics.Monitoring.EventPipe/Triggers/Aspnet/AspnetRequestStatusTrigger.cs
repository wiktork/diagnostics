...
{
    internal class AspnetRequestStatusTrigger : AspnetTrigger<AspnetRequestStatusTriggerSettings>
    {
        ...
        public AspnetRequestStatusTrigger(AspnetRequestStatusTriggerSettings settings) : base(settings)
        {
            ...
            string[] codesOrRanges = settings.StatusCodeFilter.Split(';');
            foreach(string codeOrRange in codesOrRanges)
            {
